...
const Video = ({ thumb, logo, title, channel, views, duration, when }) => (
    <div className="flex flex-col w-1/3 cursor-pointer">
        <div className="flex">
            ...
            <p className="absolute bg-black text-white p-1 transform translate-x-65 translate-y-38 text-xs">{duration}</p>
            <div className="absolute text-white flex flex-col space-y-1 transform translate-x-72 translate-y-2">
