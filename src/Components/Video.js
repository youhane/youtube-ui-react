...
const Video = ({ thumb, logo, title, channel, views, duration, when }) => (
    <div className="flex flex-col w-1/5 cursor-pointer">
        <div className="flex">
            <img src={thumb} alt={thumb} />
            <p className="absolute bg-black text-white p-1 transform translate-x-64-5 translate-y-36 text-xs">{duration}</p>
            <div className="absolute text-white flex flex-col space-y-1 transform translate-x-65 translate-y-2">
